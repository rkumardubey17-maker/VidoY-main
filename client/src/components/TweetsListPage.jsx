...
function TweetsListPage({
  ...
  return (
    <>
      <Toaster />
      <div className="flex gap-3 border-b border-slate-800 md:p-1 last:border-b-transparent">
        ...
        <div className="w-full">
          ...
          {isEditing ? (
            <div className="mb-2">
              <input
                ...
                className="w-full p-2 bg-slate-900 text-white rounded-md"
              />
              <button
          ...
          <div className="flex gap-4">
            <button
              className="group/btn flex items-center gap-x-2 border-slate-800 px-4 py-1.5 after:content-[attr(data-like)]  focus:after:content-[attr(data-like-alt)]"
              data-like={likes}
              data-like-alt={likes}
              onClick={handleLike}
            >
            ...
            >
              <svg
                ...
                stroke="currentColor"
                aria-hidden="true"
                className="h-5 w-5 text-inherit group-focus:text-cyan-300"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        {owner && (
          <div className="relative my-auto">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-slate-900 text-white rounded shadow-lg">
                <button
                  className="block px-4 w-full hover:bg-slate-600 py-2 text-left text-sm text-white"
                  onClick={handleEdit}
                >
                  Edit
                </button>
                <button
                  className="block px-4 py-2 w-full hover:bg-slate-600 text-left text-sm text-white"
