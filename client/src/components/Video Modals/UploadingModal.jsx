...
function UploadingModal({ onCancel, isUploading, fileName, fileSize }) {
  ...
  return (
    <div className="absolute inset-x-0 top-0 z-10 flex h-[calc(100vh-66px)] items-center justify-center bg-black/50 px-4 pb-[86px] pt-4 sm:h-[calc(100vh-82px)] sm:px-14 sm:py-8">
      <div className="w-full max-w-lg overflow-auto rounded-lg border border-slate-800 bg-[#020617] p-4">
        ...
        <div className="mb-6 flex gap-x-2 border p-3">
          <div className="w-8 shrink-0">
            <span className="inline-block w-full rounded-full bg-cyan-400/15 p-1 text-cyan-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            className="bg-cyan-400 px-4 py-3 text-slate-950 disabled:bg-cyan-400/15"
