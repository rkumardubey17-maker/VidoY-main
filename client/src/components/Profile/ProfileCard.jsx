      ...
      <div className="px-2 sm:px-4">
        <div className="flex flex-col gap-4 pb-4 pt-6 sm:flex-row sm:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-400">@{channelHandle}</p>
          ...
          {!owner && (
            <button
              className="w-full bg-cyan-400 px-4 py-2 text-center font-bold text-slate-950 transition-all duration-150 ease-in-out sm:w-auto rounded-sm inline-flex gap-2 items-center active:translate-x-[5px] active:translate-y-[5px] justify-center hover:bg-cyan-300"
          ...
          {owner && (
            <>
              ...
              >
                <button className="bg-cyan-400 px-4 py-2 font-bold text-slate-950 transition-transform duration-150 ease-in-out rounded-sm flex gap-2 items-center active:translate-x-[2px] active:translate-y-[2px] hover:bg-cyan-300">
                  Edit Channel
                </button>
              </Link>
        ...
        <ul className="no-scrollbar flex gap-x-2 overflow-x-auto border-b  bg-[#020617] py-2">
          {tabs.map((tab, index) => (
                ...
                <button
                  className={`w-full px-3 py-1.5 border-b-2 ${
                    location.pathname === tab.path
                      ? "border-cyan-400 font-semibold bg-white text-cyan-300"
