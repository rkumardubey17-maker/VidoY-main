      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-4">
          ...
          <Link to={`/c/${channelUsername}/videos`}>
            <div className="block">
              <p className="text-slate-200">{channelName}</p>
              <p className="text-sm text-slate-400">{subscribers} Subscribers</p>
            </div>
          </Link>
        </div>
        <div className="block">
          <button className="group/btn mr-1 flex w-full items-center gap-x-2 bg-cyan-400 px-3 py-2 text-center font-bold text-slate-950 shadow-[5px_5px_0px_0px_#334155] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#334155] sm:w-auto">
