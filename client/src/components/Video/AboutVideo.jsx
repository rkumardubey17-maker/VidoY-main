      ...
      <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
        <div className="flex items-center justify-between gap-x-4 md:justify-end lg:justify-between xl:justify-end">
          <div className="flex overflow-hidden rounded-lg border">
            <button
              className="group/btn flex items-center gap-x-2 border-r border-slate-800 px-4 py-1.5 after:content-[attr(data-like)]  focus:after:content-[attr(data-like-alt)]"
              data-like={likes}
              data-like-alt={likes}
              onClick={handleLike}
            >
            ...
            <button
              ...
              data-like-alt=""
            >
              <span className="inline-block w-5 group-focus/btn:text-cyan-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <div className="relative block">
            <button className="peer flex items-center gap-x-2 rounded-lg bg-white px-4 py-1.5 text-slate-950">
