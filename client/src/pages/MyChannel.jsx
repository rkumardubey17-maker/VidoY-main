    ...
    <>
      {owner && (
        <div className="flex items-center justify-end p-3 w-full max-w-screen-lg mx-auto">
          <button
            className="bg-cyan-400 px-4 py-2 font-bold text-slate-950 transition-transform duration-150 ease-in-out rounded-sm flex gap-2 items-center active:translate-x-[2px] active:translate-y-[2px] hover:bg-cyan-300"
            onClick={openModal}
          >
            <svg
