    ...
    <>
      ...
      {owner && (
        <div className="mx-auto w-full flex items-center justify-end px-5 py-3">
          <button
            className="bg-cyan-400 px-4 py-2 text-center font-bold text-slate-950 transition-all duration-150 ease-in-out rounded-sm inline-flex gap-2 items-center active:translate-x-[5px] active:translate-y-[5px]"
      ...
      {isOpenCreateTweet && (
        ...
        >
          ...
          <div className="flex items-center justify-end gap-x-3 px-3">
            <button
              className="bg-cyan-400 px-3 py-2 font-semibold text-slate-950"
              type="submit"
            >
      ...
      {isLoading ? (
        <div className="flex gap-3 border-b border-slate-800 p-4 last:border-b-transparent animate-pulse">
          <div className="h-14 w-14 shrink-0 bg-slate-800 rounded-full"></div>
        ...
        <div className="p-4">
          <div className="flex flex-col gap-3 border-b border-slate-800 py-4 last:border-b-transparent">
            {tweets.map((tweet) => (
              <TweetsListPage
                key={tweet._id}
        ...
        <div className="flex justify-center p-4">
          <div className="w-full max-w-sm text-center shadow-md ">
            <p className="mb-3 w-full">
              <span className="inline-flex rounded-full bg-cyan-400/15 p-2 text-cyan-300">
