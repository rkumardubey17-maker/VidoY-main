...
function Login() {
  ...
  return (
    <div className="flex w-full items-start justify-center bg-transparent px-4 py-8 text-slate-100">
      <Toaster />
      <div className="glass-surface mx-auto flex w-full max-w-md flex-col rounded-2xl p-6 sm:p-8">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Sign in to continue watching and managing your channel.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to={"/signup"}>
              <button className="rounded-full border border-slate-700 px-5 py-2 font-semibold text-slate-200 hover:border-cyan-400/60 hover:text-cyan-200">
                Signup
              </button>
            </Link>
            <button
              className="rounded-full bg-slate-800 px-5 py-2 font-semibold text-slate-200 hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
