...
function PlaylistVideo() {
  return (
    <div className="h-screen overflow-y-auto bg-[#020617] text-white">
      <header className="sticky inset-x-0 top-0 z-50 w-full border-b border-slate-800 bg-[#020617] px-4">
        <nav className="mx-auto flex max-w-7xl items-center py-2">
          ...
          <div className="relative mx-auto hidden w-full max-w-md overflow-hidden sm:block">
            <input
              className="w-full border bg-transparent py-1 pl-8 pr-3 placeholder-slate-500 outline-none sm:py-2"
              placeholder="Search"
            />
          ...
          <button className="group peer ml-4 flex w-6 shrink-0 flex-wrap gap-y-1.5 sm:hidden">
            <span className="block h-[2px] w-full bg-white group-hover:bg-cyan-400"></span>
            <span className="block h-[2px] w-2/3 bg-white group-hover:bg-cyan-400"></span>
            <span className="block h-[2px] w-full bg-white group-hover:bg-cyan-400"></span>
          </button>
          <div className="fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-slate-800 bg-[#020617] duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none">
            <div className="relative flex w-full items-center justify-between border-b border-slate-800 px-4 py-2 sm:hidden">
            ...
            <ul className="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
              <li className="w-full">
                <button className="flex w-full items-center justify-start gap-x-4 border border-slate-800 px-4 py-1.5 text-left hover:bg-cyan-400 hover:text-slate-950 focus:border-cyan-400 focus:bg-cyan-400 focus:text-slate-950">
            ...
            <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
              <button className="w-full bg-[#1e293b] px-3 py-2 hover:bg-[#334155] sm:w-auto sm:bg-transparent">
                Log in
              </button>
              <button className="mr-1 w-full bg-cyan-400 px-3 py-2 text-center font-bold text-slate-950 shadow-[5px_5px_0px_0px_#334155] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#334155] sm:w-auto">
                Sign up
              </button>
            </div>
          </div>
      ...
      <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
        <aside className="group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-t border-slate-800 bg-[#020617] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] lg:sticky lg:max-w-[250px]">
          <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
            <li className="">
              <button className="flex flex-col items-center justify-center border-slate-800 py-1 focus:text-cyan-300 sm:w-full sm:flex-row sm:border sm:p-1.5 sm:hover:bg-cyan-400 sm:hover:text-slate-950 sm:focus:border-cyan-400 sm:focus:bg-cyan-400 sm:focus:text-slate-950 sm:group-hover:justify-start sm:group-hover:px-4 lg:justify-start lg:px-4">
        ...
        <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
          <div className="flex flex-wrap gap-x-4 gap-y-10 p-4 xl:flex-nowrap">
            <div className="w-full shrink-0 sm:max-w-md xl:max-w-sm">
              ...
              <p className="flex text-sm text-slate-200">
              ...
              <div className="mt-6 flex items-center gap-x-3">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm text-slate-300">757K Subscribers</p>
                </div>
              </div>
            </div>
                ...
                <div className="w-full max-w-3xl gap-x-4 sm:flex">
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <p className="flex text-sm text-slate-200 sm:mt-3">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Code Master</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Express Learner</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">API Builder</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Hook Master</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Django Master</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">ReactD3</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Passport Pro</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">Tableau Master</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">CSS Animations</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-x-4">
                        ...
                        <p className="text-sm text-slate-200">React Patterns</p>
                      </div>
                    </div>
                  </div>
                </div>
