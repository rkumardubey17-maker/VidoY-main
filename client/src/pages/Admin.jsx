...
function Admin() {
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4">
          {Array(3)
            ...
            .map((_, index) => (
              <div
                key={index}
                className="rounded-md bg-[#0f172a] p-4 space-y-4"
              >
        ...
        <div className="overflow-hidden mt-6">
          {Array(3)
            ...
            .map((_, index) => (
              <div
                key={index}
                className="flex flex-col gap-2 p-4 mb-4 bg-[#0f172a] rounded-lg shadow animate-pulse"
              >
  ...
  return (
    <div className="mx-auto flex w-full sm:ml-[70px] sm:pb-0 lg:ml-0 flex-col gap-y-6 py-8 px-2 pb-[80px]">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4 ">
        <div className="rounded-md bg-[#0f172a] p-4">
          <div className="mb-4 block">
            <span className="inline-block h-7 w-7 rounded-full bg-cyan-400/15 p-1 text-cyan-300">
              <svg
          ...
          <h6 className="text-slate-300">Total views</h6>
        ...
        <div className="rounded-md bg-[#0f172a] p-4">
          ...
          <h6 className="text-slate-300">Total subscribers</h6>
        ...
        <div className="rounded-md bg-[#0f172a] p-4">
          ...
          <h6 className="text-slate-300">Total likes</h6>
        ...
        <table className="w-full border-collapse text-white">
          ...
          <tbody className="block md:table-row-group">
            {data?.totalVideos?.map((video) => (
              <tr
                key={video._id}
                className="flex flex-col gap-2 p-4 mb-4 bg-[#0f172a] rounded-lg shadow md:table-row md:p-0 md:shadow-none"
              >
                <td className="flex items-center justify-between md:table-cell border-b border-slate-700 py-2 md:py-3">
                  <span className="font-semibold md:hidden">Status:</span>
                  <span className="rounded-2xl px-2 py-0.5 text-green-600">
                    Published
                  </span>
                </td>
                <td className="flex items-start justify-between md:items-center md:table-cell border-b border-slate-700 py-2 md:py-3">
          ...
          <div className="bg-black p-4 rounded">
            ...
            >
              ...
              <div className="w-full">
                ...
                <textarea
                  id="desc"
                  className="h-40 w-full border border-slate-700 bg-transparent px-4 py-2 rounded-md text-white placeholder-slate-500 resize-none outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20"
              ...
              <div className="w-full">
                <Input
                  ...
                  className="file:mr-4 file:border-none file:bg-cyan-400 file:text-slate-950 file:px-4 file:py-2 file:rounded-md file:hover:bg-cyan-300 cursor-pointer"
                />
              </div>
              ...
              <div className="flex space-x-4">
                <button
                  type="submit"
                  className="px-4 py-2 bg-cyan-400 text-slate-950 rounded-md hover:bg-cyan-300 transition-colors disabled:opacity-50"
                ...
                <button
                  type="button"
                  className="px-4 py-2 bg-red-600 text-slate-950 rounded-md hover:bg-red-700 transition-colors"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-black p-4 rounded">
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button
                className="px-4 py-2 bg-slate-300 text-slate-950 rounded"
