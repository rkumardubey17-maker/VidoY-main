    ...
    <section className="w-full pb-[70px] sm:ml-[70px] lg:ml-0 sm:pb-0">
      <div className="flex flex-col lg:flex-row p-1">
        ...
        <div className="w-full lg:w-3/4">
            ...
            <div className="absolute inset-0">
              {video ? (
                ...
                <div className="w-full animate-pulse">
                  <div className="relative mb-2 w-full pt-[56%] bg-slate-800">
                    <div className="absolute inset-0 bg-slate-700"></div>
                    <span className="absolute bottom-1 right-1 inline-block rounded bg-slate-600 px-1.5 text-sm h-4 w-10"></span>
                  </div>
                </div>
              )}
            </div>
          ...
          {/* Video Information */}
          {video ? (
            <div className="group mb-4 w-full rounded-lg border border-slate-800 p-4 transition duration-200">
              <AboutVideo
                title={video.title}
                views={video.views}
            ...
            <div className="flex flex-wrap gap-y-2 animate-pulse p-1">
              <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
                ...
                <div className="mt-2 h-4 w-1/2 bg-slate-800 rounded"></div>
              </div>
              <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
                <div className="flex items-center justify-between gap-x-4">
                  <div className="flex overflow-hidden rounded-lg border">
                    <div className="h-10 w-20 bg-slate-800 rounded-l"></div>
                    <div className="h-10 w-10 bg-slate-800"></div>
                  </div>
